...
# Generated on: Thu Jan 16 11:04:56 CET 2025 (Thu Jan 16 10:04:56 UTC 2025)
...
set logfile fv/EXE/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/EXE -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/cad/cadence_2024/ddi/GENUS221/tools.lnx86"
set CDN_SYNTH_ROOT      "/cad/cadence_2024/ddi/GENUS221/tools.lnx86"
set env(CW_DIR) "/cad/cadence_2024/ddi/GENUS221/tools.lnx86/lib/chipware"
set CW_DIR      "/cad/cadence_2024/ddi/GENUS221/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /cad/cadence_2024/ddi/GENUS221/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/cad/cadence_2024/ddi/GENUS221/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/cad/cadence_2024/ddi/GENUS221/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/cad/cadence_2024/ddi/GENUS221/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/cad/cadence_2024/ddi/GENUS221/tools.lnx86/lib/chipware/sim"
}
...
add_search_path . /cad/cadence_2024/ddi/GENUS221/tools.lnx86/lib/tech -library -both
read_library -liberty -both \
    /dk/xfab/PDK/xh018/diglibs/D_CELLS_HD/v4_0/liberty_LPMOS/v4_0_0/PVT_1_80V_range/D_CELLS_HD_LPMOS_slow_1_62V_125C.lib \
    /dk/xfab/PDK/xh018/diglibs/D_CELLS_HD/v4_0/liberty_LPMOS/v4_0_0/PVT_1_80V_range/D_CELLS_HD_LPMOS_typ_1_80V_25C.lib
...
set_naming_rule "_%s_" -parameter -golden
...
set_naming_rule "%s_" -register -golden
set_naming_rule "%L.%s" "%L_%d.%s" "%s" -instance -golden
set_naming_rule "%L.%s" "%L_%d.%s" "%s" -variable -golden
...
add_search_path ../MODEL -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../MODEL/ALU.v
delete_search_path -all -design -golden
add_search_path ../MODEL -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../MODEL/EXE.v
delete_search_path -all -design -golden
add_search_path ../MODEL -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../MODEL/REGS.v
elaborate_design -golden -root {EXE} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/EXE/fv_map.v.gz
elaborate_design -revised -root {EXE}
...
#add_name_alias fv/EXE/fv_map.singlebit.original_name.alias.json.gz -revised
#set_mapping_method -alias -revised
#add_renaming_rule r1alias _(%w?(/U\\\$%d)*)$ @1 -type dff dlat -both
...
write_compared_points noneq.compared_points.EXE.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.EXE.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.EXE.rtl.fv_map.rpt
